...
import { AirEuropaDesc, AirEuropaTitle } from "../../GlobalData/GlobalMetaData";
...
function AirEuropa() {
  ...
  return (
    <>
      <Helmet>
        <title>{AirEuropaTitle}</title>
        <meta name="description" content={AirEuropaDesc} />
      </Helmet>
      {loading ? (
        <FlightLoader />
      ) : (
