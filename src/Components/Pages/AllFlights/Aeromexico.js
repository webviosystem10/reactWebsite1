...
function Aeromexico() {
  ...
  return (
    <>
      <Helmet>
        <title>{AeromexicoTitle}</title>
        <meta name="description" content={AeromexicoDesc} />
      </Helmet>
      {loading ? (
        <FlightLoader />
      ) : (
                ...
                <div className="col-lg-8 col-md-12 col-12">
                  <div className="airlines_text p-xl-5">
                    ...
                    <p className="mt-3">
                      ...
                      network of destinations, and a rewarding loyalty program
                      for its passengers. With a focus on innovation and
                      customer satisfaction, Air Canada continues to be a
                      prominent player in the global aviation industry. It also
                      offers additional services and products to enhance the
                      travel experience.
                    </p>
                    <div>
                      <img
                    ...
                    <ul>
                      <li>
                        ...
                        Aeroplan program allows members to earn and redeem
                        points for flights, upgrades, and travel services. They
                        also enjoy exclusive promotions and offers.
                      </li>
                      <li>
                        <b>
                          {" "}
                        ...
                        access, flight bonus miles, and preferred reward
                        pricing.
                      </li>
                      <li>
                        <b>
                        ...
                        It can be earned with 50,000 miles or 50 flight
                        segments. Offers priority waitlisting, upgrade priority,
                        more Maple Leaf Lounges access, and higher flight bonus
                        miles.
                      </li>
                      <li>
                        <b>
                      ...
                      <li>
                        ...
                        airport services, concierge services, highest flight
                        bonus miles, and extra Star Alliance benefits.
                      </li>
                    </ul>
                    <h1 className="mt-5">
                    ...
                    <p>
                      The airline is planning to add more flights to the fleet
                      and introduce new fly routes to enhance its connectivity
                      across the globe. Air Canada is committed to maintain its
                    ...
                    <ul>
                      <li>
                        ...
                        <p>
                          Air Canada is Canada's largest airline with an
                          extensive flight network, prioritizing safety and
                      ...
                      <li>
                        ...
                        <p>
                          Air Canada's loyalty program, Aeroplan, rewards
                          members with points for flights and offers various
                          redemption options, elite status tiers, and partner
                          benefits.
                        </p>
                      </li>
                      <li>
                        ...
                        <p>
                          Air Canada provides inflight entertainment with
