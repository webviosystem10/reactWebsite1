...
import {
  RoyalAirJordanianDesc,
  RoyalAirJordanianTitle,
...
function RoyalAir() {
  ...
  return (
    <>
      <Helmet>
        <title>{RoyalAirJordanianTitle}</title>
        <meta name="description" content={RoyalAirJordanianDesc} />
      </Helmet>
      {loading ? (
        <FlightLoader />
      ) : (
