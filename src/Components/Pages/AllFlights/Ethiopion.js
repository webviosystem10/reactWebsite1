...
import { EthiopianDesc, EthiopianTitle } from "../../GlobalData/GlobalMetaData";
...
function Ethiopion() {
  ...
  return (
    <>
      <Helmet>
        <title>{EthiopianTitle}</title>
        <meta name="description" content={EthiopianDesc} />
      </Helmet>
      {loading ? (
        <FlightLoader />
      ) : (
