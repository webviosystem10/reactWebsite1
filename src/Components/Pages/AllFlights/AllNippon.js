...
import { AllNipponDesc, AllNipponTitle } from "../../GlobalData/GlobalMetaData";
...
function AllNippon() {
  ...
  return (
    <>
      <Helmet>
        <title>{AllNipponTitle}</title>
        <meta name="description" content={AllNipponDesc} />
      </Helmet>
      {loading ? (
        <FlightLoader />
      ) : (
