...
import { FrontierDesc, FrontierTitle } from "../../GlobalData/GlobalMetaData";
...
function Frontire() {
  ...
  return (
    <>
      <Helmet>
        <title>{FrontierTitle}</title>
        <meta name="description" content={FrontierDesc} />
      </Helmet>
      {loading ? (
        <FlightLoader />
      ) : (
