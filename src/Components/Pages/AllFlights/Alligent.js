...
import { AllegientDesc, AllegientTitle } from "../../GlobalData/GlobalMetaData";
...
function Alligent() {
  ...
  return (
    <>
      <Helmet>
        <title>{AllegientTitle}</title>
        <meta name="description" content={AllegientDesc} />
      </Helmet>
      {loading ? (
        <FlightLoader />
      ) : (
