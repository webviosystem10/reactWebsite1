...
import { HawaiianDesc, HawaiianTitle } from "../../GlobalData/GlobalMetaData";
...
function Hawaiin() {
  ...
  return (
    <>
      <Helmet>
        <title>{HawaiianTitle}</title>
        <meta name="description" content={HawaiianDesc} />
      </Helmet>
      {loading ? (
        <FlightLoader />
      ) : (
