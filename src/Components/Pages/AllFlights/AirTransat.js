...
import { AirTransatDesc, AirTransatTitle } from '../../GlobalData/GlobalMetaData'
...
function AirTransat() {
  ...
  return (
    <>
    <Helmet>
        <title>{AirTransatTitle}</title>
        <meta name="description" content={AirTransatDesc} />
      </Helmet>
      {loading ? (
        <FlightLoader />
      ) :
      ...
      <div className="col-lg-8 col-md-12 col-12">
        <div className="airlines_text p-xl-5">
          ...
          <p>
            ...
            introduce new fly routes to enhance its connectivity across the
            globe. Air Canada is committed to maintain its reputation as one of
            the top airlines in the world.
          </p>
          <ul>
            <li>
              <h4 className="mt-5">What is Air Canada Known For?</h4>
              <p>
                Air Canada is Canada's largest airline with an extensive flight
                network, prioritizing safety and offering a premium travel
                experience.
              </p>
            </li>
            <li>
              ...
              <p>
                Air Canada's loyalty program, Aeroplan, rewards members with
                points for flights and offers various redemption options, elite
                status tiers, and partner benefits.
              </p>
            </li>
            <li>
              <h4 className="mt-3">
              ...
              <p>
                Air Canada provides inflight entertainment with movies, TV
