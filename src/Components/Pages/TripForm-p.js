      ...
      async function fetchData() {
        if (selectedValue === "One way") {
          ...
          var offerData = await generalGetFunction(
            `v2/shopping/flight-offers?originLocationCode=${departureItaCode}&destinationLocationCode=${arrivalItaCode}&currencyCode=USD&departureDate=${departureDate}&adults=${adult}&travelClass=${tripClass}&children=${children}&infants=${infants}&max=90`
          );
        } else {
          if (arrivalDate === "") {
            ...
            var offerData = await generalGetFunction(
              `v2/shopping/flight-offers?originLocationCode=${departureItaCode}&destinationLocationCode=${arrivalItaCode}&departureDate=${departureDate}&currencyCode=USD&returnDate=${arrivalDate}&&adults=${adult}&children=${children}&travelClass=${tripClass}&infants=${infants}&max=90`
            );
          }
        }
        if ((offerData && offerData === "error") || (offerData && offerData.data.length === 0)) {
          setTimeout(()=>{
            dispatch({
              type: "SET_LOADING",
              loading: false,
          ...
          var main = offerData.data.map((item) => {
            ...
            return {
              ...
              rawData: item,
              includedCheckedBags:{
                weight:item.travelerPricings[0]["fareDetailsBySegment"]?.[0]?.["includedCheckedBags"]?.["weight"]!==undefined?item.travelerPricings[0]["fareDetailsBySegment"][0]["includedCheckedBags"]["weight"]:"",
    ...
    <>
      ...
      >
        <div className="row">
          ...
          <div className="col-12 mt-md-4 mt-xl-4 mt-4">
          ...
          <div className="col-12 mt-md-3 mt-3 mt-xl-4">
            ...
            {departureSearch ? (
              <CircularProgress className="mui-loader-arrival-col" />
            ) : (
              ""
            )}
          ...
          <div
            className="col-12 mt-md-3 mt-3 mt-xl-4"
            id="round_dateform"
          >
            <div className="form-group form-style">
               ...
               <DatePicker
                ...
                selected={
                  arrivalDate && arrivalDate !== "Invalid Date"
                    ? selectedValue==="One way"?"":new Date(arrivalDate)
                    :""
                }
                minDate={
                  departureDate && departureDate !== "Invalid Date"
          ...
          <div className="col-12 mt-3 mt-md-3 mt-xl-4 mx-auto">
            <div className="form-group form-style">
              <input
                type="hidden"
                ...
                id="traveller"
              />
              <div className="" data-toggle="dropdown" aria-expanded="true" ref={dropdownRef}>
                <div className="travelerselectbox d-flex justify-content-evenly" >
                  
                    <div><i className="icofont-users-alt-3 fs-3" /></div>
                    <a
                          ...
                          <div className="container">
                            <div className="row">
                              <div className="col-12 text-center mt-2">
                                <a onClick={() => setDropdown(false)} href="#" className="btn passnger_submit">
                                  Submit
                                </a>
                              </div>
                            </div>
          ...
          <div
            to="/flight-search"
            className="form-group1 form-btn-style col-12 mt-md-3 mt-3 mt-xl-3 mx-auto text-center"
          >
